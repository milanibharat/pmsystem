                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="middle_name" type="text" class="form-control{{ $errors->has('middle_name') ? ' is-invalid' : '' }}" 
                                       onkeyup="this.value = this.value.toUpperCase();" name="middle_name" value="{{ old('middle_name') }}" required autocomplete="first_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="text" class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" 
                                       style="text-transform: capitalize;" name="state" value="{{ old('state') }}" required autocomplete="country">
